...
export const GRBL_SETTINGS = [
	...
	},
	{
		...
		category: "Motors",
		units: "mask",
		details: "Inverts the direction signal. Set axis bit to invert (00000ZYX).",
		dataType: AXIS_MASK,
	},
	{
		setting: "$4",
	...
	},
	{
		...
		category: "Spindle",
		units: "rpm",
		details: "Minimum spindle speed. Sets PWM to 0.4% or lowest duty cycle.",
		dataType: NUMBER,
		min: 1,
		step: 1,
	},
...
export const GRBL_HAL_SETTINGS = [
	...
	},
	{
		...
		category: "Limits",
		units: "mm",
		details: "Used in mode 1 and 2 when $TPW command is issued and in mode 3.",
		dataType: NUMBER,
		min: 0,
		step: 10,
	},
...
export const GRBL_SETTINGS_MAP = new Map(
	GRBL_SETTINGS.map((s) => [s.setting, s]),
);
