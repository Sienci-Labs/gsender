        ...
        return showEEPROMOnly ? (
            filteredSettings.length > 0 &&
                filteredSettings.map((setting: gSenderSubSection, index) => {
                    return (
                        <div key={setting.label ?? index} className="bg-gray-100 rounded-xl shadow p-6 max-xl:p-3 flex flex-col gap-6 dark:bg-surface-raised dark:text-content-primary">
                            <SettingSection
                                connected={connected}
