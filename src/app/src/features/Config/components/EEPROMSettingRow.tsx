    ...
    if (EEPROMData) {
        ...
        return (
            ...
            >
                ...
                <span className="w-full sm:w-2/5 text-gray-500 text-sm mb-2 sm:mb-0 sm:order-none order-1">
                    {detailString}
                </span>
                <div
                    className="w-full sm:w-1/5 text-xs px-4 gap-2 flex flex-col mb-0 sm:mb-0 sm:order-none order-2"
