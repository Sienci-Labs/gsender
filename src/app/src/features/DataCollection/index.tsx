    ...
    return (
        <Sheet open={open && consentStatus === 'pending'} onOpenChange={setOpen}>
            ...
            >
                ...
                <SheetDescription className="mt-6 flex flex-col items-center gap-6 text-center text-slate-600 md:flex-row md:items-start md:justify-center dark:text-slate-400">
                    <div
                    ...
                    <div className="min-w-0 max-w-prose flex-1 space-y-4">
                        ...
                        <div className="space-y-3 text-sm leading-relaxed">
                            <p>
                                We&apos;d like a clearer picture of how many
                                people use gSender, which CNCs and computers it
                                runs on, and general app usage, so we can focus
                                improvements where they matter most.
                            </p>
                            <p>
                                Nothing is collected without your permission,
                                and you can opt in or out whenever you like from
                                the settings screen.
                            </p>
                        </div>
                    </div>
