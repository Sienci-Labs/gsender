...
export function StatParent() {
    return (
        <StatsProvider>
            <div className="py-4 px-16 max-xl:px-8 pb-12 fixed-content-area w-full gap-4 flex flex-col justify-start items-start align-top no-scrollbar overflow-y-auto">
                <Outlet />
                <StatMenu />
            </div>
        </StatsProvider>
