...
export function ExternalLink({
    ...
    return (
        <a
            ...
            target="_blank"
            rel="noreferrer"
            className="drop-shadow-md hover:scale-105 rounded border-top border-2 border-t-blue-500 p-3 border-rounded-t flex flex-row items-center justify-between gap-4 flex-grow dark:bg-surface-raised dark:text-content-primary dark:border-outline dark:border-t-blue-500"
        >
