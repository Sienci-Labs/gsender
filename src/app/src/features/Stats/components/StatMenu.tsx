...
export function StatMenu() {
    return (
        <ul className="flex text-sm font-medium text-center text-gray-500 items-center justify-center border-gray-200 ring-1 ring-gray-200 rounded w-fit p-1 m-auto">
