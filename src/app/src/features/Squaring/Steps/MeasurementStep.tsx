			...
			<div className="flex flex-col gap-4">
				...
				<div className="space-y-6">
					{currentMainStepData.subSteps.map((step, index) => {
						...
						const measurementKey = getMeasurementKey(step.buttonLabel);
								...
								<div className="flex flex-col gap-2 flex-1">
									<div className="flex items-center gap-4">
										<div className="flex-1">
											<h4 className="font-medium">{step.buttonLabel}</h4>
											<div className="flex items-center gap-2 mt-2">
												<ControlledInput
													type="number"
													placeholder="Enter measurement"
													value={measurementInputs[measurementKey]}
													onChange={(e) => {
												...
												<Button
													disabled={
														!measurementInputs[measurementKey] ||
														Number(measurementInputs[measurementKey]) <= 0
													}
													onClick={() =>
