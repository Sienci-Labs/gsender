		...
		return (
			<div className="flex flex-col gap-2 dark:text-white w-full">
					...
					<div className="space-y-1 text-sm xl:text-base font-normal">
						...
						<div className="text-gray-500 dark:text-gray-300">
							...
							<ul className="list-disc list-inside">
								...
								<li>
									Put something pointed in the spindle like an old v-bit,
									tapered bit, pencil, or a pointed dowel
								</li>
							</ul>
						</div>
						...
						{!isConnected && (
							<div className="text-yellow-800 bg-yellow-100 p-4 xl:p-2 rounded-lg border flex flex-col gap-4 justify-center items-center text-center">
								<p>
									Please connect to a device before starting the squaring
									wizard.
								</p>
							</div>
						)}
				...
				<div className="flex gap-4 shrink-0">
					<Button onClick={() => setStarted(true)} disabled={isDisabled}>
						Start XY Squaring
					</Button>
				</div>
			</div>
