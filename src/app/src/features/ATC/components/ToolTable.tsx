					...
					<Table>
						<TableHeader>
							<TableRow className="grid grid-cols-[2fr_1fr_1fr_1fr] portrait:grid-cols-[2fr_1fr_1fr]">
								...
								<TableHead className={"portrait:hidden"}>Z Offset</TableHead>
								...
								>
									<TableCell className="font-mono w-full">
										<div className="flex flex-col w-full">
											<span className="font-semibold">T{tool.id}</span>
											<ToolNameInput id={tool.id} nickname={tool.nickname} />
										</div>
									</TableCell>
									<TableCell className="portrait:flex portrait:flex-col portrait:gap-2 portrait:items-center">
										<div className="portrait:block hidden">
											<ToolStatusBadges
												...
												isManual={tool.isManual && allowManualBadge}
												size="sm"
											/>
										</div>
									...
									<TableCell>
										<ProbeButton onProbe={() => probeRackTool(tool.id)} />
									</TableCell>
								</TableRow>
							))}
						</TableBody>
