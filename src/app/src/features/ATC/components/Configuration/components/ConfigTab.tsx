				...
				<Card className="border border-border dark:border-slate-700 shadow-none w-full bg-white dark:bg-dark-darker">
					...
					<CardContent className="p-5 !pt-4 min-h-[170px] flex flex-col justify-center gap-4">
						<Button
							...
							className="w-fit"
							onClick={() =>
								navigate("/tools/accessoryInstall/sienci-atc/initial-setup")
							}
						>
							Go to ATC Setup
									...
									className={cn(
										"rounded-md px-2.5 py-1.5 bg-gray-50 dark:bg-slate-800 flex items-center justify-between gap-3 w-full",
										{
											[nonDefaultStyling]:
												...
												config.variables._passthrough_offset_setting.default,
										},
									)}
								>
									...
									<Switch
										checked={
											config.variables._passthrough_offset_setting.value === 1
										}
										onChange={(checked) =>
											updateConfig({
												variables: {
								...
								<div className="space-y-3">
									...
									>
										<div className="flex items-center justify-between gap-2">
											<div className="space-y-1">
												<Label className={rowLabelClass}>Pressure Sensor</Label>
								...
								>
									<div className="flex items-center justify-between gap-2">
										...
										<Input
											...
											onChange={(e) => setForkSpacingStr(e.target.value)}
											onBlur={() => {
