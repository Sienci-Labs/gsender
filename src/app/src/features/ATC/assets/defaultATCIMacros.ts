...
; The number of slots in your magazine.
#<_tc_slots> = 6
...
o110 if [[#5399] EQ -1]
  o111 if [#<_current_tool> GT 0 AND #<_current_tool> LT #<_tc_table_size>]
...
o200 if [#<_current_tool> GT 0 AND #<_current_tool> LT #<_tc_table_size>]
  G43 H[#<_current_tool>]
...
export const defaultATCIMacros: ATCIMacroConfig = {
    ...
    variables: {
        ...
        _holder_sense: { default: 0, value: 0 },
    },
