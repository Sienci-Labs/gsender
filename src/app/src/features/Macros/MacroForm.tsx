	...
	return (
		<Dialog open onOpenChange={onCancel}>
			<DialogContent className="bg-white w-1/3 max-xl:w-[450px]">
				...
				>
					<DialogHeader>
						<DialogTitle>{id ? "Edit Macro" : "Add Macro"}</DialogTitle>
					</DialogHeader>
					<DialogDescription className="mt-1 text-sm text-gray-500">
						Macros are a way to store and reuse commands. They can be used to
						speed up repetitive tasks and make your CNC more efficient.
					</DialogDescription>
