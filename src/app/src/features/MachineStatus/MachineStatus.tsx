			...
			>
				...
				<div
					className={cx(
						...
						{
							"text-white bg-gray-800": !isConnected || !activeState,
							"bg-gray-500 text-white":
								activeState === GRBL_ACTIVE_STATE_IDLE && isConnected,
							...
							"bg-blue-500 text-white":
								activeState === GRBL_ACTIVE_STATE_HOME && isConnected,
							"bg-yellow-600 text-white":
								(activeState === GRBL_ACTIVE_STATE_HOLD ||
									activeState === GRBL_ACTIVE_STATE_DOOR) &&
								isConnected,
							"bg-red-500 text-white":
								activeState === GRBL_ACTIVE_STATE_ALARM && isConnected,
							"bg-purple-600 text-white":
								activeState === GRBL_ACTIVE_STATE_TOOL && isConnected,
						},
					)}
				>
