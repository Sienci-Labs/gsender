    ...
    return (
        <div className={styles.notConnectedWrapper}>
            ...
            <p className={styles.warningExplanation}>
                Connect to your last connected device using the button below or
                exit this window and connect to a different device.
            </p>
            <ReconnectButton onClick={onReconnectClick} disabled={disabled} />
            {disabled && (
                <p>
                    No history of machine connections, cannot connect to the
                    last machine.
                </p>
            )}
        </div>
