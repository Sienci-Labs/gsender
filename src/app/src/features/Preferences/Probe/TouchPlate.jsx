        ...
        <Fieldset legend="Touch Plate">
            <div className={styles.inputSpread}>
                ...
                <Select
                    options={[
                        {
                            label: TOUCHPLATE_TYPE_STANDARD,
                            value: TOUCHPLATE_TYPE_STANDARD,
                        },
                        {
                            label: TOUCHPLATE_TYPE_ZERO,
                            value: TOUCHPLATE_TYPE_ZERO,
                        },
                        {
                            label: TOUCHPLATE_TYPE_AUTOZERO,
                            value: TOUCHPLATE_TYPE_AUTOZERO,
                        },
                    ]}
                ...
                <>
                    <div style={{ marginBottom: '1rem' }}>
                        <span
                            ...
                            style={{ margin: '0 10px 0.9rem' }}
                        >
                            Supported probe axes for this specific touchplate
                        </span>
                        {functions.z && (
                            <Tooltip
                                content="Specify the thickness of Z axis"
                                location="default"
                            >
                                <Input
                                    label="Z Thickness"
                    ...
                    {type !== TOUCHPLATE_TYPE_ZERO && (
                        <>
                            <Tooltip
                                content="Specify the thickness of XY axis"
                                location="default"
                            >
                                <Input
                                    label="XY Thickness"
