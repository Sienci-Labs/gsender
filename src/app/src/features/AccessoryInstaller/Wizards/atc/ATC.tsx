...
export const sienciATCWizard: Wizard = {
    id: 'sienci-atc',
    title: 'Sienci ATC',
    validations: [],
    subWizards: [
...
export function ATCWithValidations() {
    const isConnected = useTypedSelector(
        (state: RootState) => state.connection.isConnected,
    );

    const baseWizard = sienciATCWizard;
    ...
    const wizard = useMemo<Wizard>(
        () => ({
            ...baseWizard,
            validations,
        }),
        [baseWizard, validations],
    );
    console.log(wizard);
