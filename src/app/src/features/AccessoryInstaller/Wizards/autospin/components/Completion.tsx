...
export function AutoSpinCompletion() {
    return (
        <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-content-secondary mb-8 max-w-2xl">
                Your AutoSpin has been successfully configured and is ready to
                use.
            </p>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 max-w-2xl">
                ...
                <ul className="text-left text-gray-700 dark:text-content-primary space-y-2">
                    ...
                    <li>
                        • Turn the AutoSpin dial to "S" and turn on the power
                        toggle
                    </li>
                    <li>
                        • Reconnect in gSender and verify your spindle starts
                        and stops from the Carve page.
                    </li>
                </ul>
            </div>
        </div>
