	...
	return (
		<div className="flex flex-col gap-5 justify-start">
			...
			<p className="dark:text-white">
				Now that your Spindle has been configured and controller rebooted, you
				must configure the Modbus Address.
			</p>
			<p>
				If you are one a modern grblHAL version this will automatically restart
				your controller
			</p>
			<p>
				If you are an older version of grblHAL, you'll need to restart the
				controller using the switch manually.
			</p>
			<StepActionButton
