	...
	return (
		...
		>
			<path
				...
				className={cn(
					canClick && !isRotaryMode ? altColourClass : disabledColorClass,
				)}
			...
			<path
				...
				fill="#3F85C7"
				className={cn(
					canClick && !isRotaryMode ? standardColourClass : disabledColorClass,
				)}
			...
			<path
				...
				fill="#3F85C7"
				className={cn(canClick ? standardColourClass : disabledColorClass)}
