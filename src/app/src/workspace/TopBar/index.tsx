...
export const TopBar = ({ isRemoteWindow }: Props) => {
    ...
    return (
        <div className="border p-3 h-14 max-xl:h-12 max-xl:p-2 box-border flex gap-4 max-sm:gap-2 items-center bg-gray-50 dark:bg-surface-base dark:border-outline">
            <RemoteMenuFlyout />
