			...
			substeps: [
				{
					...
					description: () => (
						<div>
							Jog your machine to a place you can reach using the jog controls
							and ensure that your router/spindle is turned off and has fully
							stopped spinning.
						</div>
					),
					overlay: false,
			...
			substeps: [
				{
					...
					actions: [
						...
						},
						{
							...
							gcodeLines: ["(Setting Z 0)", "G10 L20 P0 Z0", "G21"],
						},
					],
				},
			],
