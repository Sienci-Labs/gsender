    ...
    'fixed z-40 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
    {
        variants: {
            side: {
                ...
                bottom: 'inset-x-0 bottom-0 flex justify-center gap-0 border-0 bg-transparent p-0 px-4 pb-6 pt-2 shadow-none data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom',
