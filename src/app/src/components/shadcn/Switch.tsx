    ...
    return (
        ...
        >
            <SwitchPrimitives.Thumb
                className={cx(
                    'pointer-events-none block h-5 w-5 rounded-full border data-[state=checked]:border-blue-500 data-[state=unchecked]:border-gray-400 bg-white dark:bg-gray-300 dark:data-[state=unchecked]:border-dark-lighter dark:data-[state=checked]:border-blue-400 shadow-lg ring-0 transition-transform ',
                    isVertical
