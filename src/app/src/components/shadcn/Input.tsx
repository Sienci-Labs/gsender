		...
		return (
			<div className={cn("flex flex-col gap-2 w-full", wrapperClassName)}>
				{label && (
					<label
						className={cn(
							"text-sm font-medium text-gray-700 dark:text-content-primary mb-2",
						)}
					>
						{label}
					</label>
				...
				{suffix ? (
					<div
						className={cn(
							...
							"dark:bg-surface-raised dark:border-gray-500",
							boxSize,
					...
					>
						<input
							className={cn(
								...
								"text-robin-500 dark:text-content-primary placeholder:text-muted-foreground",
					...
					<div className="relative flex items-center">
						<input
							className={cn(
								...
								"text-robin-500 pr-10 dark:bg-surface-raised dark:text-content-primary dark:border-gray-500",
								inputSize,
								className,
							)}
							ref={ref}
