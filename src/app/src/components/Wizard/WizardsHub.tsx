			...
			<div className="max-w-6xl mx-auto px-8 py-16">
				<div className="mb-12">
					<div className="flex items-center gap-3 mb-4">
						<Settings size={40} className="text-gray-700 dark:text-white" />
					...
					{wizards.map((wizard) => {
						...
						return (
							<Button
								...
								size="custom"
								className="group w-full bg-white dark:bg-dark rounded-xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 text-left border-2 border-gray-100 hover:border-blue-400 relative overflow-hidden"
							>
								...
								<div className="relative w-full">
									...
									<div className="space-y-2 mb-6">
										<div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
											...
											<span>
												{wizard.subWizards.length} configuration
												{wizard.subWizards.length !== 1 ? "s" : ""}
											</span>
										</div>
				...
				{wizards.length === 0 && (
					<div className="text-center py-16">
						...
						<p className="text-xl text-gray-500">No wizards available</p>
					</div>
				)}
			</div>
		</div>
