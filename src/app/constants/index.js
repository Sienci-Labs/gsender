...
// currently they're the same, but if we add more controllers or change the current values, it may be necessary to have this
export const ACTIVE_STATE_IDLE = GRBL_ACTIVE_STATE_IDLE || GRBL_HAL_ACTIVE_STATE_IDLE;
export const ACTIVE_STATE_RUN = GRBL_ACTIVE_STATE_RUN || GRBL_HAL_ACTIVE_STATE_RUN;
export const ACTIVE_STATE_HOLD = GRBL_ACTIVE_STATE_HOLD || GRBL_HAL_ACTIVE_STATE_HOLD;
export const ACTIVE_STATE_DOOR = GRBL_ACTIVE_STATE_DOOR || GRBL_HAL_ACTIVE_STATE_DOOR;
export const ACTIVE_STATE_HOME = GRBL_ACTIVE_STATE_HOME || GRBL_HAL_ACTIVE_STATE_HOME;
export const ACTIVE_STATE_SLEEP = GRBL_ACTIVE_STATE_SLEEP || GRBL_HAL_ACTIVE_STATE_SLEEP;
export const ACTIVE_STATE_ALARM = GRBL_ACTIVE_STATE_ALARM || GRBL_HAL_ACTIVE_STATE_ALARM;
export const ACTIVE_STATE_CHECK = GRBL_ACTIVE_STATE_CHECK || GRBL_HAL_ACTIVE_STATE_CHECK;
export const ACTIVE_STATE_JOG = GRBL_ACTIVE_STATE_JOG || GRBL_HAL_ACTIVE_STATE_JOG;
export const ACTIVE_STATE_TESTING = GRBL_ACTIVE_STATE_TESTING || GRBL_HAL_ACTIVE_STATE_TESTING;
