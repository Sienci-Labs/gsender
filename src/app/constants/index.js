...
//Speeds for toggle buttons Axis Widget
export const FAST_TOGGLE_SPEED_METRIC = 5000;
export const NORMAL_TOGGLE_SPEED_METRIC = 3000;
export const PRECISE_TOGGLE_SPEED_METRIC = 3000;

export const FAST_TOGGLE_SPEED_IMPERIAL = 200;
export const NORMAL_TOGGLE_SPEED_IMPERIAL = 120;
export const PRECISE_TOGGLE_SPEED_IMPERIAL = 120;
