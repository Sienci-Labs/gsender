...
//Speed settings for toggle switches in axis widget
...
export const XY_PRECISE_TOGGLE_SPEED_IMPERIAL = IMPERIAL_STEPS[5];

export const Z_FAST_TOGGLE_SPEED_METRIC = METRIC_STEPS[16];
...
export const Z_NORMAL_TOGGLE_SPEED_IMPERIAL = IMPERIAL_STEPS[10];//NO .04 FOUND
export const Z_PRECISE_TOGGLE_SPEED_IMPERIAL = IMPERIAL_STEPS[2];//NO .004 FOUND
