    ...
    generateAutoProbe(axes) {
        ...
        if (axes.x && axes.y && axes.z) {
            code.push(
                ...
                'G4 P0.15',
                '%X_RIGHT = posx',
                '%X_CENTER = (X_RIGHT - (0 - X_LEFT)) / 2',
                `${prependUnits} G90 G0 X[X_CENTER]`,
                'G21 G91 G0 Y-13',
                'G38.2 Y-30 F250',
                'G21 G91 G0 Y2',
                'G38.2 Y-5 F75',
                ...
                'G4 P0.15',
                '%Y_UP = posy',
                '%Y_CENTER = (Y_UP - (0 - Y_DOWN)) / 2',
                `${prependUnits} G90 G0 X[X_CENTER] Y[Y_CENTER]`,
                'G4 P0.15',
                'G21 G91 G0 X22.5 Y22.5',
                'G21 G90 Z1'
            );
            ...
            code.push(
                ...
                '%Y_UP = posy',
                '%Y_CENTER = (Y_UP - (0 - Y_DOWN)) / 2',
                `${prependUnits} G90 G0 Y[Y_CENTER]`,
                'G4 P0.15',
                'G21 G91 G0 Y22.5',
            );
        }
