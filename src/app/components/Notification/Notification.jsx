        ...
        return (
            <Modal>
                <div className={styles.modalContainer}>
                    <div className="fas fa-exclamation" style={{ fontSize: 40, color: '#3e85c7', textAlign: 'center', marginTop: 15 }} />
                    ...
                    <div className={styles.notificationButtonContainer}>
                        <button type="button" className={styles.notificationButtons} onClick={onYes}>Yes</button>
