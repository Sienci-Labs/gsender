...
const HalFlashModal = ({ onClose }) => {
    ...
    useEffect(() => {
        ...
        controller.addListener('task:error', _throttle((data) => {
                ...
                <div className={styles.wrapper}>
                    <div className={styles.body}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem', alignItems: 'center' }}>
                            <label htmlFor="firmware_image" style={{ margin: 0 }}>Choose a hex file</label>
                            <input
                                type="file"
                                id="firmware_image"
                                accept=".hex"
            ...
            <Modal.Footer>
                    ...
                    isCompleted && !isFlashing && (
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <div className="buttonContainer">
                                <Button primary onClick={onClose}>Exit</Button>
                            </div>
                        </div>
                    )
                }
                {
                    !isCompleted && !isFlashing &&
                        (
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                <h1 className="footer-text">This process will disconnect your machine and may take a few minutes to complete.</h1>
