...
// Active State
export {
	ACTIVE_STATE_IDLE as GRBL_HAL_ACTIVE_STATE_IDLE,
	ACTIVE_STATE_RUN as GRBL_HAL_ACTIVE_STATE_RUN,
	ACTIVE_STATE_HOLD as GRBL_HAL_ACTIVE_STATE_HOLD,
	ACTIVE_STATE_DOOR as GRBL_HAL_ACTIVE_STATE_DOOR,
	ACTIVE_STATE_HOME as GRBL_HAL_ACTIVE_STATE_HOME,
	ACTIVE_STATE_SLEEP as GRBL_HAL_ACTIVE_STATE_SLEEP,
	ACTIVE_STATE_ALARM as GRBL_HAL_ACTIVE_STATE_ALARM,
	ACTIVE_STATE_CHECK as GRBL_HAL_ACTIVE_STATE_CHECK,
} from "../shared/constants";
...
export const GRBL_HAL_MODAL_GROUPS = [
	{
		...MODAL_GROUPS.motion,
		modes: MODAL_GROUPS.motion.modes.flatMap((mode) =>
			mode === "G3" ? [mode, "G5"] : [mode],
		),
	},
	MODAL_GROUPS.wcs,
	{
	...
	MODAL_GROUPS.plane,
	MODAL_GROUPS.units,
	MODAL_GROUPS.distance,
	MODAL_GROUPS.feedrate,
	MODAL_GROUPS.program,
	{
		// Cycle retract
		group: "cycle",
		modes: ["G98", "G99"],
	},
	MODAL_GROUPS.spindle,
	MODAL_GROUPS.coolant,
];
...
export const GRBL_HAL_SETTINGS_INPUT_TYPES = {
	NUMBER: SETTINGS_INPUT_TYPES.NUMBER,
	MASK: "mask",
	...SETTINGS_INPUT_TYPES,
	SELECT: "select",
	STRING: "string",
