...
// Active State
export {
	ACTIVE_STATE_IDLE as GRBL_ACTIVE_STATE_IDLE,
	ACTIVE_STATE_RUN as GRBL_ACTIVE_STATE_RUN,
	ACTIVE_STATE_HOLD as GRBL_ACTIVE_STATE_HOLD,
	ACTIVE_STATE_DOOR as GRBL_ACTIVE_STATE_DOOR,
	ACTIVE_STATE_HOME as GRBL_ACTIVE_STATE_HOME,
	ACTIVE_STATE_SLEEP as GRBL_ACTIVE_STATE_SLEEP,
	ACTIVE_STATE_ALARM as GRBL_ACTIVE_STATE_ALARM,
	ACTIVE_STATE_CHECK as GRBL_ACTIVE_STATE_CHECK,
} from "../shared/constants";
...
export const GRBL_MODAL_GROUPS = Object.values(MODAL_GROUPS);
...
export const GRBL_ALARMS = [...ALARMS, HOMING_ALARM];

export const GRBL_SETTINGS_INPUT_TYPES = SETTINGS_INPUT_TYPES;
