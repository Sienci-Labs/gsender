...
export default function SpindlePanel({ mode }: Props) {
	...
	const enableSpindleMode = () => {
		...
		const SLBLaserExists =
			...
			findIndex(availableSpindles, (o: any) => o.label === "SLB_LASER") !== -1;
	...
	const actions = {
		...
		getWCS(): number {
			return (
				(
					{ G54: 1, G55: 2, G56: 3, G57: 4, G58: 5, G59: 6 } as Record<
						string,
						number
					>
				)[wcs] || 0
		...
		>
			...
			<div className="flex items-center gap-2 px-4 pb-3 shrink-0">
				<div
					className={clsx(
						"flex-[2]",
						(!hasSpindles || !clickable) && "opacity-40 pointer-events-none",
					)}
				>
					<Select
