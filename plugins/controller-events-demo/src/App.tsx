...
const App = () => {
    ...
    useEffect(() => {
        ...
        getSelector<boolean>(
            (state) =>
                (state as { connection?: { isConnected?: boolean } })
    ...
    return (
        <main className="app">
            <header>
                ...
                <p className="lede">
                    <code>machine.addListener(name, callback)</code> mirrors
                    gSender's own <code>controller.addListener</code>
                </p>
            </header>
            ...
            <section className="card">
                <h2>Watching</h2>
                <p className="hint">
                    This demo only listens for a handful of events.
                </p>
            ...
            <section className="card">
                <h2>Job controls</h2>
                <p className="hint">
                    Trigger a job without leaving this page, so{' '}
                    <code>job:start</code>/<code>job:stop</code> show up below.
                    Loading the sample will replace anything currently loaded in
                    the visualizer.
                </p>
                ...
                {!connected && (
                    <p className="hint">
                        Connect to a machine to enable these buttons.
                    </p>
                )}
            </section>
            ...
            <section className="card">
                ...
                {entries.length === 0 ? (
                    <p className="hint">
                        Waiting for one of the events above to fire…
                    </p>
                ) : (
                    <ul className="log">
                        {entries.map((entry) => (
