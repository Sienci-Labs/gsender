...
it("Test Case: jogging using buttons and zeroing axes", () => {
    ...
    cy.unlockMachineIfNeeded();
		...
		cy.get("button").contains("Console").should("be.visible").click();
		cy.wait(1000);
		...
		cy.log(
			"Step 9: Verifying console contains details about moving to X zero axis...",
		);
		...
		cy.log(
			"Step 11: Verifying console contains details about moving to Y zero axis...",
		);
		...
		cy.log(
			"Step 13: Verifying console contains details about moving to Z zero axis...",
		);
		...
		cy.log(
			"Step 15: Verifying console contains details about moving to XY zero axes...",
		);
