describe('Park feature ', () => {
    ...
    it('Enables homing and set park location to 0,0,0', () => {
        ...
        cy.log(
            'Step 4: Recording initial positions before setting park location...',
        );
        ...
        cy.get('span[data-testid="mpos-X"]')
            ...
            .then((text) => {
                ...
                expect(initialX).to.not.equal(
                    0,
                    'X should not be 0 after jogging',
                );
            });
        ...
        cy.get('span[data-testid="mpos-Y"]')
            ...
            .then((text) => {
                ...
                expect(initialY).to.not.equal(
                    0,
                    'Y should not be 0 after jogging',
                );
            });
        ...
        cy.get('span[data-testid="mpos-Z"]')
            ...
            .then((text) => {
                ...
                expect(initialZ).to.not.equal(
                    0,
                    'Z should not be 0 after jogging',
                );
            });
        ...
        cy.get(
            '#section-5 span.sm\\:order-none > div > div:nth-of-type(1) input',
        )
            .clear()
            .type('0');
        cy.wait(300);
        ...
        cy.get(
            '#section-5 span.sm\\:order-none > div > div:nth-of-type(2) input',
        )
            .clear()
            .type('0');
        cy.wait(300);
        ...
        cy.get('button.bg-robin-500.text-white')
            .find(
                'svg path[d="M6 3H13C16.3137 3 19 5.68629 19 9C19 12.3137 16.3137 15 13 15H10V21H6V3ZM10 7V11H13C14.1046 11 15 10.1046 15 9C15 7.89543 14.1046 7 13 7H10Z"]',
            )
            .parent('svg')
            .parent('span')
            .parent('button')
        ...
        cy.get('span[data-testid="mpos-X"]')
            ...
            .then((text) => {
                ...
                expect(parkedX).to.be.closeTo(
                    0,
                    0.01,
                    'X position should be 0 after parking',
                );
            });
        ...
        cy.get('span[data-testid="mpos-Y"]')
            ...
            .then((text) => {
                ...
                expect(parkedY).to.be.closeTo(
                    0,
                    0.01,
                    'Y position should be 0 after parking',
                );
            });
        ...
        cy.get('span[data-testid="mpos-Z"]')
            ...
            .then((text) => {
                ...
                expect(parkedZ).to.be.closeTo(
                    0,
                    0.01,
                    'Z position should be 0 after parking',
                );
        ...
        cy.get('span[data-testid="mpos-X"]')
            ...
            .then((text) => {
                ...
                expect(positionX).to.be.closeTo(
                    5,
                    0.1,
                    'X position should be 5 after Go To',
                );
            });
        ...
        cy.get('span[data-testid="mpos-Y"]')
            ...
            .then((text) => {
                ...
                expect(positionY).to.be.closeTo(
                    5,
                    0.1,
                    'Y position should be 5 after Go To',
                );
            });
        ...
        cy.get('span[data-testid="mpos-Z"]')
            ...
            .then((text) => {
                ...
                expect(positionZ).to.be.closeTo(
                    5,
                    0.1,
                    'Z position should be 5 after Go To',
                );
        ...
        cy.log(
            'Step 26: Clicking Grab button to capture current machine position...',
        );
        ...
        cy.log(
            'Step 27: Verifying park position fields match jogged positions...',
        );
        ...
        cy.get(
            ...
            .then((xValue) => {
                ...
                expect(parkX).to.be.closeTo(
                    joggedX,
                    0.1,
                    'X park position should match jogged X position',
                );
            });
        ...
        cy.get(
            ...
            .then((yValue) => {
                ...
                expect(parkY).to.be.closeTo(
                    joggedY,
                    0.1,
                    'Y park position should match jogged Y position',
                );
            });
        ...
        cy.get('#section-5 fieldset:nth-of-type(3) div:nth-of-type(3) input')
            ...
            .then((zValue) => {
                ...
                expect(parkZ).to.be.closeTo(
                    joggedZ,
                    0.1,
                    'Z park position should match jogged Z position',
                );

                cy.log(
                    'Grab feature verified: Park positions match current machine positions',
                );
            });
    });
});
