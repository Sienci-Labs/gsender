describe('Go to axis  Movements by Adding and  Values Test', () => {
    ...
    it('Test Case 1: Precise Mode - Adding and Subtracting Preset Values', () => {
        ...
        cy.get(
            'div.items-center > div > div:nth-of-type(1) > div > div:nth-of-type(3) path',
        ).click();
        cy.wait(500);
        ...
        cy.get('div.gap-1 > div.items-center > div > div:nth-of-type(1) input')
            ...
            .then((xyValue) => {
                ...
                cy.get(
                    'div.h-\\[75\\%\\] div:nth-of-type(2) > div > div:nth-of-type(3) svg',
                ).click();
                cy.wait(500);
                ...
                cy.get(
                    ...
                    .then((zValue) => {
                        ...
                        cy.get(
                            'div:nth-of-type(3) > div > div:nth-of-type(3) path',
                        ).click();
                        cy.wait(500);
                        ...
                        cy.get(
                            'div.flex-row > div.flex path:nth-of-type(2)',
                        ).click();
                        cy.wait(2000);
                        cy.verifyAxes(0, 0, 0);

                        cy.log(
                            'Step 17: Testing decrement - clicking XY decrement button...',
                        );
                        cy.get(
                            'div.h-\\[75\\%\\] div.items-center > div > div:nth-of-type(1) > div > div:nth-of-type(1) svg',
                        ).click();
                        cy.wait(500);

                        cy.log(
                            'Step 18: Moving X+Y+ with decremented value...',
                        );
                        cy.get('#xPlusYPlus').click();
                        cy.wait(2000);
                        ...
                        cy.get(
                            ...
                            .then((newXYValue) => {
                                ...
                                cy.log(
                                    `XY moved to: ${newXY} (after decrement)`,
                                );
                                cy.verifyAxes(newXY, newXY, 0);

                                cy.log(
                                    'Step 20: Decrementing Z preset value...',
                                );
                                cy.get(
                                    '#app > div > div.h-full div.items-center > div > div:nth-of-type(2) > div > div:nth-of-type(1) svg',
                                ).click();
                                cy.wait(500);

                                cy.log(
                                    'Step 21: Moving Z+ with decremented value...',
                                );
                                cy.get(
                                    'div.flex-shrink-0 div.flex-row > div.flex path:nth-of-type(1)',
                                ).click();
                                ...
                                cy.get(
                                    ...
                                    .then((newZValue) => {
                                        ...
                                        cy.log(
                                            `Z moved to: ${newZ} (after decrement)`,
                                        );
                                        cy.verifyAxes(newXY, newXY, newZ);

                                        cy.log(
                                            'Step 23: Decrementing feed rate...',
                                        );
                                        cy.get(
                                            'div.items-center > div > div:nth-of-type(3) > div > div:nth-of-type(1) svg',
                                        ).click();
                                        cy.wait(500);

                                        cy.log(
                                            'Step 24: Moving Y- to return...',
                                        );
                                        cy.get('#yMinus').click();
                                        cy.wait(2000);
    ...
    it('Test Case 2: Normal Mode - Adding and Subtracting Go to axis  Values', () => {
        ...
        cy.log('Step 4: Incrementing XY preset value...');
        cy.get(
            'div.gap-1 > div.items-center > div > div:nth-of-type(1) div:nth-of-type(3) > button',
        ).click();
        cy.wait(500);
            ...
            .then((xyValue) => {
                ...
                cy.get(
                    ...
                    .then((zValue) => {
                        ...
                        cy.log('Step 10: Incrementing feed rate...');
                        cy.get(
                            'div:nth-of-type(3) > div > div:nth-of-type(3) svg',
                        ).click();
                        cy.wait(500);
                        ...
                        cy.get(
                            'div.h-\\[75\\%\\] div.items-center > div > div:nth-of-type(1) > div > div:nth-of-type(1) path',
                        ).click();
                        cy.wait(500);
                        ...
                        cy.get(
                            ...
                            .then((newXYValue) => {
                                ...
                                cy.get(
                                    '#app > div > div.h-full div.items-center > div > div:nth-of-type(2) > div > div:nth-of-type(1) path',
                                ).click();
                                cy.wait(500);
    ...
    it('Test Case 3: Rapid Mode - Adding and Subtracting Go to axis Values', () => {
        ...
        cy.log('Step 4: Incrementing XY preset value...');
        cy.get(
            'div.items-center > div > div:nth-of-type(1) > div > div:nth-of-type(3) svg',
        ).click();
        cy.wait(500);
                            ...
                            .then((newXYValue) => {
                                ...
                                cy.get(
                                    ...
                                    .then((newZValue) => {
                                        ...
                                        cy.log(
                                            'RAPID MODE TEST COMPLETED SUCCESSFULLY',
                                        );
                                    });
                            });
                    });
