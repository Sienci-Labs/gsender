...
describe('Master Test Suite - All Tests', () => {
  ...
  import('./joggingusingbuttonsslb.cy.js');

  import('./file_info_display.specslb.cy.js');

  import('./gotolocationgrblHal.cy');
  ...
  import('./pausejobgrblslb.cy.js');

  import('./start_from_line.specslb.cy.js');

  import('./Stoppingjobgrblslb.cy.js');

  import('./coolant_spec_grbHalslb.cy.js');
  ...
  import('./console_communicationgrblHalslb.cy.js');

  import('./movement_tuningslb.cy.js');
