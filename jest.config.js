module.exports = {
    ...
    moduleNameMapper: {
        ...
        'react-syntax-highlighter':
            '<rootDir>/src/app/src/__mocks__/reactSyntaxHighlighterMock.js',
        '^react-markdown$':
            '<rootDir>/src/app/src/__mocks__/reactMarkdownMock.js',
        '^app-root/(.*)$': '<rootDir>/$1',
        '^react-icons/(.*)$':
            '<rootDir>/src/app/src/__mocks__/reactIconsMock.js',
        ...
        '^@react-pdf/renderer$':
            '<rootDir>/src/app/src/__mocks__/reactPdfMock.js',
    },
